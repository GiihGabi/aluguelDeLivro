...
<body>
    ...
    <header class="header">
        <div class="header__container">
            ...
            <a href="#" class="header__logo">Giovanna Batista</a>
                        ...
                        <div class="nav__dropdown">
                            ...
                            <div class="nav__dropdown-collapse">
                                <div class="nav__dropdown-content">
                                    <a href="<?= URL ?>cadastraraluno" class="nav__dropdown-item">Aluno</a>
                                    <a href="<?= URL ?>cadastrarautor" class="nav__dropdown-item">Autor</a>
                                    <a href="<?= URL ?>cadastrarlivro" class="nav__dropdown-item">Livro</a>
                                </div>
                            </div>
                        </div>

                        <a href="<?= URL ?>alugarlivro" class="nav__link">
                            <i class='bx bx-book-alt nav__icon'></i>
                            <span class="nav__name">Alugar Livro</span>
                        </a>

                        <a href="<?= URL ?>devolucao" class="nav__link">
                            <i class='bx bxs-pen nav__icon'></i>
                            <span class="nav__name">Devolução de Livro</span>
                        </a>
                    </div>
                </div>
            </div>
